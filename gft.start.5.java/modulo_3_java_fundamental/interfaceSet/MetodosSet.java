...
public class MetodosSet {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("\nO conjunto notas está vazio? " + notas.isEmpty());
		System.out.println("\nO conjunto notas2 está vazio? " + notas2.isEmpty());
		System.out.println("\nO conjunto notas3 está vazio? " + notas3.isEmpty());
	}
}
