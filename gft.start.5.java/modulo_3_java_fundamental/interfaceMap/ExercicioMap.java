...
public class ExercicioMap {
	...
	System.out.println("\nDicionário popução NE do Brasil: " + populacao.toString());
	...
	System.out.println("\nDicionario em ordem de inserção: " + populacao1.toString());
	...
	System.out.printf("\nEstado com a menor população: (%s) com (%d) pessoas", minPop, Collections.min(populacao3));
	System.out.printf("\nEstado com a maior população: (%s) com (%d) pessoas", maxPop, Collections.max(populacao3));
	...
	System.out.println("\nA soma das populações dos estados do NE é: " + s);
	...
	*/
	...
	System.out.println("\nA média das população dos estados do NE é: " + m);
	...
	System.out.println("O dicionario está vazio? " + status2);
